const Footer = () => {
  return (
    <footer className="bg-white  px-6 md:px-16 py-16 mt-10">
      <div>
        <div className="mb-12">
          <h1 className="text-6xl md:text-7xl font-bold text-[#4441CC] ">
            IdeaVault
          </h1>
        ...
        {/* Grid Section */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 text-[#4441CC]">
          {/* Newsletter */}
          <div>
            ...
            <div className="flex items-center text-white bg-gray-800 px-4 py-3">
              <input
                type="email"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="hover:text-black cursor-pointer">My Bookings</li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© 2026 IdeaVault. All rights reserved.</p>
